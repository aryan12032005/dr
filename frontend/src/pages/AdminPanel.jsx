  ...
  return (
    <div className="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 min-h-screen p-4 ">
      ...
      <div className="container mx-auto">
        ...
        <nav className="bg-gray-800 p-4 mb-4 rounded-lg shadow-md"> {/* Added margin-bottom */}
        <div className="container mx-auto flex justify-between items-center">
          <span className="text-white font-bold text-xl">Admin Dashboard</span> {/* Navbar title */}
          <div>
            
            <a href="#" className="text-gray-300 hover:text-white mr-4">User Management</a>
            <a href="#" className="text-gray-300 hover:text-white mr-4">Document management</a>
            <a href="#" className="text-gray-300 hover:text-white mr-4">Settings</a>
            <a href="#" className="text-gray-300 hover:text-white mr-4"> New User Sign up</a>
          </div>
        </div>
      </nav>
